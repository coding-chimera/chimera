...
Generates UPCOMING_CHANGELOG.md by running the Chimera changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for chimera run (default: low)
      --quiet            Suppress chimera command output unless it fails
