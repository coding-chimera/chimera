'use strict';
//
// Programmatic / embedded SDK entry for @opencode-ai/chimera (issue #354).
//
...
var pkg = '@opencode-ai/chimera-' + target;
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @opencode-ai/chimera --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @opencode-ai/chimera status`) to\n' +
