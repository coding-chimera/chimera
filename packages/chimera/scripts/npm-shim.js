...
// optionalDependency: @opencode-ai/chimera-<platform>-<arch>. npm installs
...
function resolveInstalledBundle() {
  try {
    if (isWindows) {
      ...
      var entry = require.resolve(pkg + '/lib/dist/cli/chimera.js');
...
function fail(reason) {
  process.stderr.write(
    ...
    '      npm i -g @opencode-ai/chimera --registry=https://registry.npmjs.org\n' +
