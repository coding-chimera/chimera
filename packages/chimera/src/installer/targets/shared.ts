...
export function getCodeGraphPermissions(): string[] {
  return [
    'mcp__chimera__codegraph_explore',
    'mcp__chimera__codegraph_search',
    'mcp__chimera__codegraph_node',
    'mcp__chimera__codegraph_callers',
    'mcp__chimera__codegraph_callees',
    'mcp__chimera__codegraph_impact',
    'mcp__chimera__codegraph_files',
    'mcp__chimera__codegraph_status',
  ];
}
