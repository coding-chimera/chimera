...
/**
 * Blank string contents while preserving quotes and offsets (K-v2 P5-1 port
 * of the upstream N helper). Template interpolations are blanked too; callers
 * checking executable expressions must conservatively inspect those
 * expressions in the original source.
 */
