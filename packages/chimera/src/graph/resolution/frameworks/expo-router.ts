// FORK STATUS (G-C): adopted as closure support for vue-router/sveltekit-router
// (route-table readers, href parsers). `expoRouterResolver` is NOT registered in
// `frameworks/index.ts` yet — its synthesizer half (expo-router-synthesizer,
// next-link passes) and tests land in a later upstream-alignment batch.
/**
