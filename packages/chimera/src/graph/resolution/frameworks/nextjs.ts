...
// (`destinationsForHref`). `nextjsResolver` is NOT registered in
// `frameworks/index.ts` yet — its synthesizer half (next-router-synthesizer,
// nextLinkEdges) and tests land in a later upstream-alignment batch.
/**
