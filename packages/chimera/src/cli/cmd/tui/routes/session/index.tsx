...
export function Session() {
  ...
  // Gated on the server capability (upstream 2892e97c57): the shortcut is dead
  // when the delegation.background_subagents kill-switch is off server-side.
    ...
    <Switch>
      ...
      <Match when={true}>
        <InlineTool icon="←" pending="Preparing edit…" complete={props.input.filePath} part={props.part}>
          Edit {normalizePath(props.input.filePath!)} {input({ edits: props.input.edits?.length, delete: props.input.delete, rename: props.input.rename })}
        </InlineTool>
      </Match>
    </Switch>
  )
