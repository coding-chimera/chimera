...
import { getApplicableFrameworks } from '../../src/graph/resolution/frameworks';
...
import { djangoResolver } from '../../src/graph/resolution/frameworks/python';
...
import { flaskResolver, fastapiResolver } from '../../src/graph/resolution/frameworks/python';
...
import { expressResolver } from '../../src/graph/resolution/frameworks/express';
...
import { nestjsResolver } from '../../src/graph/resolution/frameworks/nestjs';
...
import { laravelResolver } from '../../src/graph/resolution/frameworks/laravel';
...
import { railsResolver } from '../../src/graph/resolution/frameworks/ruby';
...
import { springResolver } from '../../src/graph/resolution/frameworks/java';
...
import { playResolver } from '../../src/graph/resolution/frameworks/play';
import { isSourceFile, isPlayRoutesFile } from '../../src/graph/extraction/grammars';
...
import { goResolver } from '../../src/graph/resolution/frameworks/go';
...
import { rustResolver } from '../../src/graph/resolution/frameworks/rust';
...
import { aspnetResolver } from '../../src/graph/resolution/frameworks/csharp';
...
import { vaporResolver } from '../../src/graph/resolution/frameworks/swift';
