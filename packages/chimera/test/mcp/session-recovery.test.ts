...
// Exercises the patched SDK transport: a session-bound POST that comes back 404 must
// reinitialize once and retry on the replacement session rather than surfacing the 404.
