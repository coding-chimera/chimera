...
```bash
chimera run "Explain how closures work in JavaScript"
```
...
```bash "chimera run"
chimera run Explain the use of context in Go
```
...
chimera run --attach http://localhost:4096 "Explain async/await in JavaScript"
```
