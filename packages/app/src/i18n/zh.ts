...
export const dict = {
  ...
  "dialog.variant.ultra.enter.title": "切换到 ultra？",
  "dialog.variant.ultra.enter.description": "ultra 会改变系统提示前缀（多智能体模式），本次会话的提示缓存命中率将暂时下降。",
  "dialog.variant.ultra.leave.title": "离开 ultra？",
  "dialog.variant.ultra.leave.description": "将恢复之前的系统提示前缀，本次会话的提示缓存命中率将暂时下降。",
  "dialog.variant.ultra.confirm": "切换",
