export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Chimera",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Chimera.",
  ...
  "provider.connect.opencodeZen.visit.link": "coding-chimera.github.io/chimera/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Chimera.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Chimera.",
  ...
  "dialog.plugins.empty": "Plugins configured in chimera.json or chimera.jsonc",
  ...
  "dialog.server.description": "Switch which Chimera server this app connects to.",
  ...
  "toast.update.description": "A new version of Chimera ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Chimera project",
  ...
  "error.chain.checkConfig": "Check your config (chimera.json or chimera.jsonc) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Chimera does not support MCP authentication yet.',
  ...
  "sidebar.help": "Help",
  "sidebar.help.unavailable.title": "Chimera help",
  "sidebar.help.unavailable.description": "Use /help in the Chimera CLI for local help. No upstream opencode help link is configured.",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "Chimera includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Chimera Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Chimera server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Chimera",
  ...
  "settings.general.row.appearance.description": "Customise how Chimera looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Chimera follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Chimera is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Chimera launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Chimera.",
